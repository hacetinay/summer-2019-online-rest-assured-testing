...
//    And Response Body should contain all countries data
    @Test
    public void test9() {
        List<String> countries = given().
                accept(ContentType.JSON).
                when().
                get("/countries").
                thenReturn().jsonPath().get("items.country_name");
        ...
        @Test
        public void test10(){
            List<String> region_id=given().
                    accept(ContentType.JSON).
                    when().
                    get("/countries").
                    thenReturn().jsonPath().get("items.region_id");

            System.out.println(region_id);
            System.out.println(region_id.size());
 }
}